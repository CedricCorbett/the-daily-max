    ...
    <Shell>
      ...
      <div style={{ padding: '20px 20px 120px', flex: 1, animation: 'slide-up 0.4s ease-out' }}>
        ...
        <div style={{ textAlign: 'center', marginTop: 10, marginBottom: 20 }}>
          <div className="mono uppercase" style={{ fontSize: 11, letterSpacing: 3, color: 'var(--streak)' }}>✓ DEFAULT · NOT · FAIL</div>
          ...
          <div className="mono" style={{ fontSize: 11, color: 'var(--text-dim)', marginTop: 10, letterSpacing: 1.5 }}>
        ...
        <div style={{ background: 'var(--bg-2)', borderLeft: '3px solid var(--accent)', padding: '12px 14px', marginBottom: 18 }}>
          <div style={{ fontSize: 15, fontWeight: 500 }}>{finishLine}</div>
        </div>
        ...
        <div style={{ background: 'var(--card)', border: '1px solid var(--streak)', padding: 16, marginBottom: 12 }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end' }}>
            <div>
              <div className="mono uppercase" style={{ fontSize: 11, letterSpacing: 2, color: 'var(--streak)' }}>STREAK</div>
              <BigNum n={state.streak} unit="DAYS" color="var(--streak)" size={44} />
            </div>
            <div style={{ textAlign: 'right' }}>
              <div className="mono" style={{ fontSize: 11, color: 'var(--text-mute)' }}>LIFETIME</div>
        ...
        {featured && featured.next && (
          <div style={{ background: 'var(--card)', border: '1px solid var(--border)', padding: 14, marginBottom: 12 }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 8 }}>
              ...
              <div className="mono" style={{ fontSize: 11, color: 'var(--accent)' }}>{featured.pct}%</div>
            </div>
        ...
        <div style={{ background: 'var(--card)', border: '1px solid var(--border)', padding: 12, marginBottom: 12 }}>
          <div className="mono uppercase" style={{ fontSize: 10, letterSpacing: 2, color: 'var(--text-mute)', marginBottom: 10 }}>ELITE CLUBS · LIFETIME</div>
          {progress.map(p => (
            <div key={p.ex.id} style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 6 }}>
              <div className="mono" style={{ width: 60, fontSize: 11, color: 'var(--text-dim)' }}>{p.ex.short}</div>
              ...
              <div className="mono" style={{ width: 92, textAlign: 'right', fontSize: 11, color: 'var(--text)' }}>
        ...
        {isPR && (
          <div style={{ background: 'var(--streak-dim)', border: '1px solid var(--streak)', padding: 12, marginBottom: 12, textAlign: 'center' }}>
            <div className="mono uppercase" style={{ fontSize: 11, letterSpacing: 2, color: 'var(--streak)' }}>★ NEW PERSONAL BEST ★</div>
          </div>
        )}
        ...
        {state.streak % 7 === 0 && state.streak > 0 && (
          <div style={{ background: 'var(--card)', border: '1px solid var(--accent)', padding: 12, marginTop: 12, textAlign: 'center' }}>
            <div className="mono uppercase" style={{ fontSize: 11, letterSpacing: 2, color: 'var(--accent)' }}>
